...
public class DateUtil {
    ...
    /**
     * Construct a time query tool that specifies the start and end times
     *
     * @param days time frame
     * @return PagerDTO
     */
    ...
    /**
     * Count the number of records within a specified number of days
     *
     * @param dayRange How many days ahead
     * @param dates    data source
